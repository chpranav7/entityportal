...
import { csvFileUpload, updateAccount, deleteAccount } from '../../services/services';
...
const handleEdit = (account) => {
    console.log("Editing account with ID:", account.accountId); // Debug log
    const updatedAccount = { ...account, amount: account.amount + 100 };
    updateAccount(account.accountId, updatedAccount)
        .then(response => {
