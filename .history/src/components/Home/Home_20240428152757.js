...
export default function Home() {
  ...
  const handleEdit = (account) => {
    // Define the details for the account update
    const updatedAccount = { ...account, amount: account.amount + 100 }; // Example update
    updateAccount(account.accountId, updatedAccountDetails)
      .then(response => {
